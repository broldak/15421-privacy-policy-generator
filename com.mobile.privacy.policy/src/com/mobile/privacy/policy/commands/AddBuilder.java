package com.mobile.privacy.policy.commands;
...
import com.mobile.privacy.policy.PolicyBuilder;
	 ...
	 public Object execute(final ExecutionEvent event) {  
	  ...
	  if (project != null) {  
	   try {  
	    ...
	    buildCommand.setBuilderName(PolicyBuilder.BUILDER_ID);  
	 ...
	 public static final boolean hasBuilder(final IProject project) {  
	  try {  
	   for (final ICommand buildSpec : project.getDescription().getBuildSpec()) {  
	    if (PolicyBuilder.BUILDER_ID.equals(buildSpec.getBuilderName()))  
	     return true;  
	   }  
	  } catch (final CoreException e) {  
	  }  
